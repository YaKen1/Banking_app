...
CREATE TABLE `accounts` (
  ...
  PRIMARY KEY (`id`),
  KEY `customer_id` (`customer_id`)
) ENGINE=MyISAM AUTO_INCREMENT=900000011 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(368,'Point Cires',1),
(369,'Sidi Lyamani',1),
(370,'Sidi Mohamed ben Abdallah el-R',1),
(371,'Zinat',1),
(372,'Ajdir',1),
(373,'Aknoul',3),
(374,'Al Hoceïma',1),
...
CREATE TABLE `customers` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=900000010 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `transactions_control`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `transactions_control` WRITE;
/*!40000 ALTER TABLE `transactions_control` DISABLE KEYS */;
/*!40000 ALTER TABLE `transactions_control` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user_registrations` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=900000007 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-05-26 21:25:30
